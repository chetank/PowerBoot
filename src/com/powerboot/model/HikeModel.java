...
public class HikeModel {
    ...
    private List<HikeFeature> hikeFeatures;
    ...
    public List<HikeFeature> getHikeFeatures() {
		return hikeFeatures;
	}
	public void setHikeFeatures(List<HikeFeature> hikeFeatures) {
		this.hikeFeatures = hikeFeatures;
	}
}
